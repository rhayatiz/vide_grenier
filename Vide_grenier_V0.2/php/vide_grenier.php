        ...
        <div class="accordion-body" style="background-color: #f7f7f7;">
            ...
            <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                        <span class="px-sm-3">Le <strong>{{DATE}}</strong> à <strong>{{HEURE}}</strong></span>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                        <span class="px-sm-3">{{Full address}}</span>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <span class="px-sm-3">{{NB_Emplacements}}</span>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <span style="background-color:#C7E0AF; border-radius: 15px; color:#0D6F1C;" class="py-1 px-3"><strong>{{Places dispo}}</strong> Places disponibles</span>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                  ...
                  <div class="col">
                    <div class="btn mx-auto btn-primary">
                        Réservez
                    </div>
                  </div>
                  </div>
